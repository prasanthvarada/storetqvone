...
describe('Controller Tests', function () {
    ...
    describe('AceHealthCheckController', function () {
        var $scope, jhiHealthService; // actual implementations
        var createController; // local utility functions

        beforeEach(inject(function ($injector, AceHealthService) {
            $scope = $injector.get('$rootScope').$new();
            jhiHealthService = AceHealthService;
            var locals = {
                '$scope': $scope
            };
            createController = function() {
                $injector.get('$controller')('AceHealthCheckController as vm', locals);
            };
            createController();
        }));
