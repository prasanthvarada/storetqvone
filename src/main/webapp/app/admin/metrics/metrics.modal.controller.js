(function() {
    ...
    angular
        ...
        .controller('AceMetricsMonitoringModalController', AceMetricsMonitoringModalController);

    AceMetricsMonitoringModalController.$inject = ['$uibModalInstance', 'threadDump'];

    function AceMetricsMonitoringModalController ($uibModalInstance, threadDump) {
        var vm = this;
